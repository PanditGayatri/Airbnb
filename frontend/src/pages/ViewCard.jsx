...
function ViewCard() {
  ...
  let [qrVisible, setQrVisible] = useState(false);
        ...
        <div className="w-[100%] min-h-[100%] flex items-center justify-center flex-col gap-[30px] bg-[#ffffffcd] absolute top-[0px] z-[100] p-[20px] backdrop-blur-sm md:flex-row md:gap-[100px]">
          ...
          >
            ...
            <div className="w-[100%] h-[70%] mt-[10px] rounded-lg p-[10px]">
              ...
              {!qrVisible ? (
                <div className="w-[90%] flex items-center justify-center flex-col gap-[10px] mt-[20px]">
                  <button
                    className="px-[40px] py-[8px] bg-[blue] text-[white] text-[16px] rounded-lg"
                    onClick={() => {
                      setQrVisible(true);
                      setTimeLeft(120);
                    }}
                ...
                <div className="w-[90%] flex items-center justify-center flex-col gap-[10px] mt-[20px]">
                  <img
                    ...
                    alt="QR Code"
                    className="w-[150px] h-[150px] border-[2px] border-[#555656]"
                  />
                  <div className="text-[18px] font-semibold">
                    Time Left: {Math.floor(timeLeft / 60)}:
                    {(timeLeft % 60).toString().padStart(2, "0")}
                  </div>
                  <label htmlFor="screenshot" className="text-[16px]">
                  ...
                  {screenshot && (
                    <button
                      className="px-[80px] py-[10px] bg-[red] text-[white] text-[18px] rounded-lg"
